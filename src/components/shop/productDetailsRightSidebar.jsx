...
const ProductDetailsRightSidebar = () => {
  useEffect(() => {
    // Initialize AOS
    AOS.init({
      duration: 1000,
                          ...
                          <div className="reviews-comment">
                            ...
                            <div className="single-review">
                              ...
                              <div className="review-content">
                                ...
                                <span className="date"><i className="far fa-calendar-alt"></i> 10 May, 2023</span>
                                  ...
                                  <div className="col-md-12">
                                    ...
                                    <div className="reviews-rating">
                                      ...
                                      <ul id="rating" className="rating">
                                        <li className="star" title='Poor' data-value='1'><i className="fas fa-star"></i></li>
                                        <li className="star" title='Poor' data-value='2'><i className="fas fa-star"></i></li>
                                        <li className="star" title='Poor' data-value='3'><i className="fas fa-star"></i></li>
                                        <li className="star" title='Poor' data-value='4'><i className="fas fa-star"></i></li>
                                        <li className="star" title='Poor' data-value='5'><i className="fas fa-star"></i></li>
                                      </ul>
                                    </div>
                                    {/* Single Form End */}
                                  </div>
...
export default ProductDetailsRightSidebar;