                ...
                <div class="page-banner-wrapper">
                    ...
                    <div class="page-banner-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="main-title">Learn about Carserv.</h2>
                        </div>
                        <!-- Section Title End -->
                ...
                <div class="about-wrapper">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-xl-6 col-lg-7 col-md-9">
                            <!-- About Content Start -->
                            <div class="about-content content-02 text-center" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="section section-padding-02">
            <div class="container">
                ...
                <div class="call-to-action-wrapper">
                    ...
                    <div class="call-to-action-images" style="background-image: url(assets/images/call-to-action-bg-2.jpg);"></div>
        ...
        <div class="section section-padding-02">
            <div class="container">
                ...
                <div class="section-title text-center">
                    ...
                    <h2 class="main-title">Talented Mechanics</h2>
                                ...
                                <div class="team-content">
                                    <div class="content-wrapper">
                                        ...
                                        <div class="team-meta">
                                            ...
                                            <p class="meta">Rating: <span>5</span></p>
                                        </div>
                                        <ul class="social">
                            ...
                            <div class="single-team" data-aos="fade-up" data-aos-delay="200">
                                ...
                                <div class="team-content">
                                    <div class="content-wrapper">
                                        ...
                                        <div class="team-meta">
                                            <p class="meta">Exprience: <strong>8 years</strong></p>
                                            <p class="meta">Rating: <span>4.9</span></p>
                                        </div>
                                        <ul class="social">
                                            <li><a href="#"><i class="fa fa-whatsapp"></i></a></li>
                                            <li><a href="#"><i class="fa fa-facebook-f"></i></a></li>
                            ...
                            <div class="single-team" data-aos="fade-up" data-aos-delay="400">
                                ...
                                <div class="team-content">
                                    <div class="content-wrapper">
                                        ...
                                        <div class="team-meta">
                                            <p class="meta">Exprience: <strong>8 years</strong></p>
                                            <p class="meta">Rating: <span>4.7</span></p>
                                        </div>
                                        <ul class="social">
                                            <li><a href="#"><i class="fa fa-whatsapp"></i></a></li>
                                            <li><a href="#"><i class="fa fa-facebook-f"></i></a></li>
