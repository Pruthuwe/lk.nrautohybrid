                ...
                <div class="page-banner-wrapper">
                    ...
                    <div class="page-banner-content">
                        ...
                        <div class="section-title">
                            <h5 class="sub-title">Checkout</h5>
                            <h2 class="main-title">Shopping <br> Checkout</h2>
                        </div>
                        <!-- Section Title End -->
                            ...
                            <div class="card-body">
                                ...
                                <form action="#">
                                    ...
                                    <div class="single-form d-flex align-items-center">
                                        <button class="btn btn-custom-01">Login</button>
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="checkout-form">
                                    ...
                                    <div class="form-check checkout-checkbox">
                                        ...
                                        <label class="form-check-label" for="shipping">Ship to a different address?</label>
                                    </div>
