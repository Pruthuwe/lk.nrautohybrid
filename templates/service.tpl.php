                ...
                <div class="page-banner-wrapper">
                    ...
                    <div class="page-banner-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="main-title">What we Provide.</h2>
                        </div>
                        <!-- Section Title End -->
            ...
            <div class="container">
                ...
                <div class="about-wrapper">
                    <div class="row">
                        <div class="col-lg-7">
                            <!-- About Images Start -->
                            <div class="about-images images-03 pt-5" data-aos="fade-right" data-aos-delay="200">
                                <div class="images">
        ...
        <div class="section ">
            <div class="container">
                <div class="section-padding-02 position-relative">
                   ...
                   <!-- <img class="services-shape" src="assets/images/services.png" alt="Service" style="width:300px; height:310px; object-fit:contain;"> -->
                        ...
                        <div class="row gx-lg-5">
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="single-service" data-aos="fade-up" data-aos-delay="200">
                                    <h4 class="title"><a href="service-details.html">Brake & Safety system </a></h4>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="single-service" data-aos="fade-up" data-aos-delay="400">
                                    <h4 class="title"><a href="service-details.html"> Engine & <br> Transmission services</a></h4>
                                    ...
                                    <div class="service-icon">
                                        <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 600 600" style="enable-background:new 0 0 600 600;" xml:space="preserve">
                                            ...
                                            L203.97,426.93z M203.97,426.93" />
                            ...
                            <div class="col-lg-4 col-sm-6">
                                ...
                                <div class="single-service" data-aos="fade-up" data-aos-delay="600">
                                    <h4 class="title"><a href="service-details.html">Auto electronic  <br> System</a></h4>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <!-- Single Service Start -->
                                <div class="single-service" data-aos="fade-up" data-aos-delay="200">
                                    <h4 class="title"><a href="service-details.html">Hybrid battrey services</a></h4>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <!-- Single Service Start -->
                                <div class="single-service" data-aos="fade-up" data-aos-delay="400">
                                    <h4 class="title"><a href="service-details.html">Auto electrical system</a></h4>
                            ...
                            <div class="col-lg-4 col-sm-6">
                                <!-- Single Service Start -->
                                <div class="single-service" data-aos="fade-up" data-aos-delay="600">
                                    <h4 class="title"><a href="service-details.html">All kind of services <br>Repair</a></h4>
                                    ...
                                    <div class="service-icon">
                                        ...
                                        c-13.81,15.87-31.01,28.43-50.32,36.78H350.59z" />
