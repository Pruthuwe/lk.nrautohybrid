                ...
                <div class="page-banner-wrapper">
                    ...
                    <div class="page-banner-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="main-title">Blog <br> Details</h2>
                        </div>
                        <!-- Section Title End -->
                    ...
                    <div class="row flex-row-reverse">
                        <div class="col-lg-8">
                            ...
                            <div class="blog-details-content">
                                ...
                                <h2 class="title">Anti-lock Brake Servicing is very important for your Vehical</h2>
                                ...
                                <blockquote class="blockquote" style="background-image: url(assets/images/blog/blockquote-bg.jpg);">
                                ...
                                <div class="description-img">
                                    <div class="dec-img">
                                        <img src="assets/images/blog/details-dec-1.jpg" alt="Details">
                                    </div>
                                    <div class="dec-img">
                                        <img src="assets/images/blog/details-dec-2.jpg" alt="Details">
                                    </div>
                                </div>
                            ...
                            <div class="blog-details-next-previews">
                                ...
                                <div class="blog-details-previews">
                                    <a href="#">
                            ...
                            <div class="blog-details-comment">
                                <div class="comment-items">
                                    <h3 class="title">02 Comments</h3>
                                    <ul>
                                        <li>
                                            <!-- Blog Details Comment Start -->
                                            <div class="single-comment">
                                                <div class="comment-image">
                                                    <img src="assets/images/author/author-17.jpg" alt="author">
                                                </div>
                                                <div class="comment-content">
                                                    <h4 class="name">Alfred Rasel</h4>
                                                    <ul class="meta">
                                                        <li> <i class="fa fa-calendar"></i> 28 May, 2023</li>
                                                        <li> <i class="fa fa-clock-o"></i> 12.45 PM</li>
                                                    </ul>
                                        ...
                                        <li>
                                            ...
                                            <div class="single-comment">
                                                <div class="comment-image">
                                                    <img src="assets/images/author/author-18.jpg" alt="author">
                                                </div>
                                                <div class="comment-content">
                                                    <h4 class="name">Christina Lopez</h4>
                                                    <ul class="meta">
                                                        <li> <i class="fa fa-calendar"></i> 28 May, 2023</li>
                                                        <li> <i class="fa fa-clock-o"></i> 12.45 PM</li>
                                                    </ul>
                                        ...
                                        <form action="#">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <!-- Single Form Start -->
                                                    <div class="single-form">
                                                        <button class="btn btn-custom-01">Post Comment</button>
                                                    </div>
                                                    <!-- Single Form End -->
                                                </div>
                                            </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="sidebar-03">
                                ...
                                <div class="widget-sidebar">
                                    <a class="banner" href="#"><img src="assets/images/banner-2.jpg" alt="Banner"></a>
                                </div>
                                <!-- Widget Sidebar End -->
