...
?> 
                ...
                <div class="page-banner-wrapper">
                    ...
                    <div class="page-banner-content">
                        ...
                        <div class="section-title">
                            ...
                            <h2 class="main-title">Full Car Diagnostic</h2>
                        </div>
                        <!-- Section Title End -->
            ...
            <div class="container">
                ...
                <div class="project-details-wrapper">
                    ...
                    <div class="details-image">
                        <img src="assets/images/gallery/project-details.jpg" alt="Project Details">
                    </div>

                    <div class="row">
                        <div class="col-md-6">
                            <div class="details-image">
                                <img src="assets/images/gallery/details-dec-1.jpg" alt="Project Details">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="details-image">
                                <img src="assets/images/gallery/details-dec-2.jpg" alt="Project Details">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="project-details-content">
                                <h2 class="title">Full Car Diagnostic</h2>
        ...
        <div class="section section-padding-02 related-projects-section">
            <div class="container">
